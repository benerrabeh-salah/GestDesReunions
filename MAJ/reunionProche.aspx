<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="reunionProche.aspx.cs" Inherits="GestDesReunions.MAJ.reunionProche" %>
                    ...
                    <table class="table table-striped table-bordered table-responsive table-hover">
                        <thead class="table-success">
                            <tr>
                                ...
                                <th style="width: 200px">Date prochaine réunion</th>
                                <th>Objet réunion</th>
                            ...
                            <asp:Repeater runat="server" ID="ReunionTable">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="width: 200px"><%# Eval("proch_reunion") %></td>
