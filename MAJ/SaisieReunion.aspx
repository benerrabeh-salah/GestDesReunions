<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SaisieReunion.aspx.cs" Inherits="GestDesReunions.MAJ.SaisieReunion" %>
        ...
        <div class="col-md-8">
            <div class="card mt-4" style="background-color: #EAE7DD">
                <div class="card-header d-flex justify-content-center">
                    <h1>Saisie d'une nouvelle réunion</h1>
                </div>
                ...
                <div class="card-body" style="background-color: #add8e6">
                    ...
                    <div class="row mt-3 d-flex justify-content-center">
                        <div class="col-md-6 col-md-offset-1">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" TextMode="Date" Enabled="True" name="BrandName" ID="Tdate_reunion" CssClass="form-control input-sm"></asp:TextBox>
                            </div>
                        </div>

                        <div class="col-md-4 col-md-offset-1">
                            <div class="form-group">
                                <asp:Label runat="server"><b>Division</b></asp:Label><br />
                                <asp:DropDownList ID="Ddivision" runat="server" name="BrandName" CssClass="form-control dropdown-toggle">
                                </asp:DropDownList>
                            </div>
                        </div>
                    ...
                    <div class="row mt-3 d-flex justify-content-center">
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" TextMode="MultiLine" Enabled="True" name="BrandName" ID="Tsujet_reunion" CssClass="form-control input-sm"></asp:TextBox>
                            </div>
                    ...
                    <div class="row mt-3 d-flex justify-content-center">
                        ...
                        <div class="col-md-4 col-md-offset-1">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="DCadre" runat="server" name="BrandName" CssClass="form-control dropdown-toggle" OnSelectedIndexChanged="DCadre_SelectedIndexChanged" AutoPostBack="True">
                    ...
                    <div class="row mt-3 d-flex justify-content-center">
                        <div class="col-md-10 col-md-offset-1">
                          ...
                          <%--      <table border="0" cellpadding="10" cellspacing="5">
                                ...
                                <asp:TextBox runat="server" TextMode="MultiLine" Enabled="True" name="BrandName" ID="TPartenaire" CssClass="form-control input-sm"></asp:TextBox>
                    ...
                    <div class="row mt-3 d-flex justify-content-center">
                        <div class="col-md-8 col-md-offset-1">
                            ...
                            <asp:TextBox runat="server" Visible="true" name="BrandName" ID="T_contri_fina" placeholder="Contribution" CssClass="form-control input-sm"></asp:TextBox>
                            <br />
                    ...
                    <div class="row mt-3 d-flex justify-content-center">
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" TextMode="MultiLine" Enabled="True" name="BrandName" ID="T_recommendation" CssClass="form-control input-sm"></asp:TextBox>
                            </div>
                    ...
                    <div class="row mt-3 d-flex justify-content-center">
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" TextMode="MultiLine" Enabled="True" name="BrandName" ID="T_etatAv" CssClass="form-control input-sm"></asp:TextBox>
                            </div>
                    ...
                    <div class="row mt-3 d-flex justify-content-center">
                        <div class="col-md-6 col-md-offset-1">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" TextMode="Date" Enabled="True" name="BrandName" ID="T_proch_reunion" CssClass="form-control input-sm"></asp:TextBox>
                            </div>
                        </div>

                        <div class="col-md-4 col-md-offset-1">
                            <div class="form-group">
                                <asp:Label runat="server"><b>Statut Réunion</b></asp:Label><br />
                                <asp:DropDownList ID="DStatut" runat="server" name="BrandName" CssClass="form-control dropdown-toggle">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 d-grid justify-content-center">
                        <div class="form-group">
                            ...
                            <asp:Button Text="  Ajouter  " ID="btnsave" Width="200px" Class="btn btn-primary btn-block" runat="server" OnClick="btnsave_Click" />
